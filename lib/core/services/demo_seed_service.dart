...
class DemoSeedService {
  ...
  Future<void> populate() async {
    ...
    final goBox  = await Hive.openBox(ProfileService.boxName(HiveInit.goalsBoxName, pid));
    final buBox  = await Hive.openBox(ProfileService.boxName(HiveInit.budgetsBoxName, pid));
    ...
    final goals = [
      ...
      GoalEntity(
        id: 'dgoal_5',
        type: GoalType.spendingCeiling,
        title: 'Teto Assinaturas',
        targetAmount: null,
        currentAmount: null,
        categoryId: 'dcat_subs',
        limitAmount: 150.0,
        month: DateTime(now.year, now.month, 1),
      ),
    ];
